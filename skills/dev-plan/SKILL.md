...
5. **Grill the plan**: before finalizing, run the `grill` skill (included in this suite) — interrogate assumptions, alternatives, and decision branches with the user until shared understanding.
